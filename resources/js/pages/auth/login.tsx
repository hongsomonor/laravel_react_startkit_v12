...
export default function Login() {
    ...
    return (
        <div className="flex h-screen w-full items-center justify-center bg-white">
            <div className="flex w-[700px] flex-col gap-8 rounded-2xl text-gray-600 font-bold bg-gray-100 px-2 py-4 shadow-md">
                ...
                <div className="mx-auto flex w-[90%] flex-col gap-2">
                    ...
                    >
                        <img src={google_icon} className="w-[30px]" alt="" />
                        <span className="text-gray-600 font-bold transition-all duration-300 group-hover:text-orange-500">Login With Google</span>
                    </button>
                    <a
                        href="#"
                        className="group mx-auto flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border-1 border-gray-300 bg-white p-4 font-bold text-white transition-all duration-300 hover:border-orange-600"
                    >
                        <img src={fb_icon} className="w-[20px]" alt="" />
                        <span className="text-gray-600 font-bold transition-all duration-300 group-hover:text-orange-500">Login With Facebook</span>
                    </a>
                </div>
                <div className="mx-auto mb-6 flex w-[90%] items-center justify-center gap-1">
                    <span className='text-gray-600 font-bold'>Don't have an account?</span>
                    <a href="#" className="font-bold text-orange-400">
                        Create New Hasssssssss
                    </a>
                </div>
            </div>
        </div>
